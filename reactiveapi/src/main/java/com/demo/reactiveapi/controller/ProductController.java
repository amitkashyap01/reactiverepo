package com.demo.reactiveapi.controller;

import com.demo.reactiveapi.model.Product;
import com.demo.reactiveapi.model.ProductEvent;
...
public class ProductController {
    ...
    @GetMapping("{id}")
    public Mono<ResponseEntity<Product>> getAProduct(@PathVariable String id){
